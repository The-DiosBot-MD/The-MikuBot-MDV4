...
await conn.reply(m.chat, `${lenguajeGB['smsAvisoRG']()}ღ ${lenguajeGB['smsMens1']()} | ${type} 
ღ ${lenguajeGB['smsMens2']()} | ${isEnable ? lenguajeGB.smsEncender() : lenguajeGB.smsApagar()} 
ღ ${lenguajeGB['smsMens3']()} | ${isAll ? lenguajeGB.smsMens4() : isUser ? '' : lenguajeGB.smsMens5()}`, fkontak, m)}	
/await conn.sendButton(m.chat, `${lenguajeGB['smsAvisoRG']()}ღ *${lenguajeGB['smsMens1']()} | ${type} 
ღ ${lenguajeGB['smsMens2']()} | ${isEnable ? lenguajeGB.smsEncender() : lenguajeGB.smsApagar()} 
ღ ${lenguajeGB['smsMens3']()} | ${isAll ? lenguajeGB.smsMens4() : isUser ? '' : lenguajeGB.smsMens5()}, wm, null, [[${isEnable ? lenguajeGB.smsApagar() : lenguajeGB.smsEncender()}, `${isEnable ? `.off ${type} : .on ${type}}`], [lenguajeGB.smsConMenu(), '.menu']], fkontak, m)}*/

...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/The-DiosBot-MD/The-MikuBot-MDV4\ncd The-MikuBot-MDV4\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/The-DiosBot-MD/The-MikuBot-MDV4 && cd The-MikuBot-MDV4
...
echo -e "\033[01;32m\033[01mIniciando The-MikuBotV4!\n\033[0m"
npm start

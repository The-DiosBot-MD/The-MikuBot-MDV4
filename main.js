...
mobile: MethodMobile, 
browser: opcion == '1' ? ['The-MikuBot-MDV4', 'Edge', '2.0.0'] : methodCodeQR ? ['The-MikuBot-MDV4', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
const subBotDirectory = './MikuJadiBot';
...
(async () => {
global.conns = [];
const mainBotAuthFile = 'MikuBotSession';
try {
